// supabase.js ทำหน้าที่เป็น Proxy/Wrapper แปลงโครงสร้างคำสั่งคิวรี่
// ระหว่างโค้ดส่วนอื่นที่เป็น PascalCase ให้สามารถใช้กับ Supabase Database ที่เป็น lowercase snake_case ได้
